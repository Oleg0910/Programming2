...
namespace o_2_C
{
    ...
    class User: IClassGenerics<User>
    {
        ...
        [RegularExpression(@"^[A-Z0-9]{10}$", ErrorMessage = "Driver License must be 10 characters, containing uppercase letters and/or digits")]
