    ...
    class Collection
    {
        ...
        public void EditUser(int userId, string toEdit, string value)
        {
            ...
            if (userToEdit != null)
            {
                ...
                while (!Validation.ValidateUserData<User>(userToEdit.ToCSVString()))
                {
        ...
        public void FileUsers(string filePath)
        {
            ...
            using (var reader = new StreamReader(filePath))
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (!Validation.ValidateUserData<User>(line)) { continue; }
        ...
        {
            string filePath = "C:\\Users\\09102\\Documents\\Навчальна_Практика\\2\\2\\2\\Users.csv";
